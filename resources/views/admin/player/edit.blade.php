                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                @enderror
                                <input type="text" id="first_name" name="first_name" class="form-control" value="{{$player->first_name}}" placeholder="First Name">
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @error('last_name')
                                    <span style="color:red; font-size: 0.8em">{{ $message }}</span>
                                @enderror
                                <input type="text" id="last_name" name="last_name" class="form-control" value="{{$player->last_name}}" placeholder="Last Name">
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                    ...
                                    @enderror
                                    <div>
                                        <input id="dob" name="dob" class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" value="{{$player->dob}}" />
                                    </div>
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @enderror
                                <br>
                                <input type="text" id="country" name="country" class="form-control" value="{{$player->country}}" placeholder="Nationality">
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @error('email')
                                    <span style="color:red; font-size: 0.8em">{{ $message }}</span>
                                @enderror
                                <input type="email" id="email" name="email" class="form-control" value="{{$player->email}}" placeholder="Email">
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @error('contact_no')
                                    <span style="color:red; font-size: 0.8em">{{ $message }}</span>
                                @enderror
                                <input type="text" id="contact_no" name="contact_no" class="form-control" value="{{$player->contact_no}}" placeholder="Contact No.">
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @error('father_name')
                                    <span style="color:red; font-size: 0.8em">{{ $message }}</span>
                                @enderror
                                <input type="text" id="father_name" name="father_name" class="form-control" value="{{$player->father_name}}" placeholder="Father Name">
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @error('mother_name')
                                    <span style="color:red; font-size: 0.8em">{{ $message }}</span>
                                @enderror
                                <input type="text" id="mother_name" name="mother_name" class="form-control" value="{{$player->mother_name}}" placeholder="Mother Name">
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @error('agent_name')
                                    <span style="color:red; font-size: 0.8em">{{ $message }}</span>
                                @enderror
                                <input type="text" id="agent_name" name="agent_name" class="form-control" value="{{$player->agent_name}}" placeholder="Agent Name">
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @enderror
                                <div>
                                    <input id="contract_start_date" name="contract_start_date" class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" value="{{$player->contract_start_date}}" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @enderror
                                <div>
                                    <input id="contract_end_date" name="contract_end_date" class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" value="{{$player->contract_end_date}}" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @error('salary_per_month')
                                    <span style="color:red; font-size: 0.8em">{{ $message }}</span>
                                @enderror
                                <input type="number" id="salary_per_month" name="salary_per_month" class="form-control" value="{{$player->salary_per_month}}" placeholder="Salary per month">
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @error('buying_price')
                                    <span style="color:red; font-size: 0.8em">{{ $message }}</span>
                                @enderror
                                <input type="number" id="buying_price" name="buying_price" class="form-control" value="{{$player->buying_price}}" placeholder="Buying Price">
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @error('previous_club')
                                    <span style="color:red; font-size: 0.8em">{{ $message }}</span>
                                @enderror
                                <input type="text" id="previous_club" name="previous_club" class="form-control" value="{{$player->previous_club}}" placeholder="Previous Club">
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @error('jersy_no')
                                    <span style="color:red; font-size: 0.8em">{{ $message }}</span>
                                @enderror
                                <input type="number" id="jersy_no" name="jersy_no" class="form-control" value="{{$player->jersy_no}}" placeholder="Jersy No.">
                            </div>
                                        ...
                                        <div>
                                            <div class="fileupload fileupload-new" id="imageUploader" data-provides="fileupload">
                                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                    <img src="{{asset('/')}}image/player/{{$player->image}}" alt="" />
                                                </div>
                                                ...
                                                <div class="uploadbtn">
                                                    ...
                                                    <input type="file" name="image" class="default" value="{{$player->image}}" />
                                                    </span>
